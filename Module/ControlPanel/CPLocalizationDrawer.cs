    ...
    public class CPLocalizationDrawer
    {
        ...
        private static void DrawSetting(Rect position)
        {
            ...
            if (_settings == null)
            {
                ...
                {
                    _settings = CreateAsset.CreateAndGetScriptableAsset<LocaleSettings>(isPingAsset: false);
                    Init();
                }
            }
            else
        ...
        private static void CreateLocalizedAssetPopup(Vector2 mousePosition)
        {
            ...
            EditorUtility.DisplayPopupMenu(popupPosition, "Assets/Create/Sunflower2/Localization/", null);
        }
