...
namespace VirtueSky.ControlPanel.Editor
{
    ...
    {
#if VIRTUESKY_IAP
        private static IapSettings _iapSetting;
#endif
...
#if VIRTUESKY_IAP
            _iapSetting = CreateAsset.GetScriptableAsset<VirtueSky.Iap.IapSettings>();
        ...
        public static void OnDrawIap(Rect position)
        {
            ...
            if (_iapSetting == null)
            {
                ...
                {
                    _iapSetting =
                        CreateAsset.CreateAndGetScriptableAsset<VirtueSky.Iap.IapSettings>();
                    Init();
                }
            }
            else
