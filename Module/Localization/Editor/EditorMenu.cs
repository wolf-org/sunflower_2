...
namespace VirtueSky.LocalizationEditor
{
    ...
    {
        private const string MENU_NAME = "Sunflower2/Localization/Change Locale/";

        [MenuItem("Sunflower2/Localization/Import CSV", priority = 10000)]
        private static void ImportCsv()
        {
            LocaleEditorUtil.Import();
        }

        [MenuItem("Sunflower2/Localization/Export CSV", priority = 10001)]
