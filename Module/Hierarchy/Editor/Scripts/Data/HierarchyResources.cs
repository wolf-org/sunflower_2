...
namespace VirtueSky.Hierarchy.Data
{
    ...
    public class HierarchyResources
    {
        ...
        {
            {
                HierarchyTexture.HierarchyColorButton,
            ...
            {
                HierarchyTexture.HierarchyErrorIcon,
            ...
            {
                HierarchyTexture.HierarchyMonoBehaviourIcon,
            ...
            {
                HierarchyTexture.HierarchyPrefabIcon,
            ...
            {
                HierarchyTexture.HierarchyRendererButton,
            ...
            {
                HierarchyTexture.HierarchyRestoreButton,
            ...
            {
                HierarchyTexture.HierarchyTreeMapCurrent,
            ...
            {
                HierarchyTexture.HierarchyTreeMapLast,
            ...
            {
                HierarchyTexture.HierarchyTreeMapLevel,
            ...
            {
                HierarchyTexture.HierarchyTreeMapLevel4,
            ...
            {
                HierarchyTexture.HierarchyTrimIcon,
            ...
            {
                HierarchyTexture.HierarchyVisibilityButton,
            ...
            {
                HierarchyTexture.HierarchyTreeMapLine,
        ...
        {
            {
                HierarchyTexture.HierarchyCheckBoxChecked,
            ...
            {
                HierarchyTexture.HierarchyCheckBoxUnchecked,
            ...
            {
                HierarchyTexture.HierarchyDragButton,
